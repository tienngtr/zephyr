...
/**
 * Export a P-256 key pair private key.
 *
 * @param key_id PSA key ID
 * @param private_key Output private key bytes
 * @param private_key_size Buffer size
 * @param private_key_len Actual bytes written
 * @return PSA_SUCCESS on success, PSA error code on failure
 */
