...
/** Maximum number of credentials in excludeList / allowList */
#define FIDO2_MAX_ALLOW_LIST 8
...
struct fido2_make_credential_params {
	...
	uint8_t exclude_ids[FIDO2_MAX_ALLOW_LIST][FIDO2_CREDENTIAL_ID_MAX_SIZE];
	/** excludeList credential ID lengths */
	size_t exclude_id_lens[FIDO2_MAX_ALLOW_LIST];
